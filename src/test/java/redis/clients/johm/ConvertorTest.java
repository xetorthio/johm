...
public class ConvertorTest extends Assert {
    ...
    public void testSupportedConvertorsUnsignedValues() {
        // boolean
        String value = "true";
        Object converted = JOhmUtils.Convertor.string2object(Boolean.class, value);
        assertTrue(converted.getClass().equals(Boolean.class));
        assertEquals(Boolean.TRUE, converted);

        converted = JOhmUtils.Convertor.string2object(boolean.class, value);
        assertTrue(converted.getClass().equals(Boolean.class));
        assertEquals(Boolean.TRUE, converted);

        // byte
        value = "50";
        converted = JOhmUtils.Convertor.string2object(Byte.class, value);
        ...
        // char
        value = "J";
        converted = JOhmUtils.Convertor.string2object(Character.class, value);
        assertTrue(converted.getClass().equals(Character.class));
        assertEquals(Character.valueOf('J'), converted);

        converted = JOhmUtils.Convertor.string2object(char.class, value);
        assertTrue(converted.getClass().equals(Character.class));
        assertEquals(Character.valueOf('J'), converted);
        ...
        // short
        value = "10";
        converted = JOhmUtils.Convertor.string2object(Short.class, value);
        ...
        // int
        value = "10";
        converted = JOhmUtils.Convertor.string2object(Integer.class, value);
        assertTrue(converted.getClass().equals(Integer.class));
        assertEquals(Integer.valueOf("10"), converted);

        converted = JOhmUtils.Convertor.string2object(int.class, value);
        assertTrue(converted.getClass().equals(Integer.class));
        assertEquals(Integer.valueOf("10"), converted);

        // float
        value = "10.0f";
        converted = JOhmUtils.Convertor.string2object(Float.class, value);
        ...
        // double
        value = "10.0d";
        converted = JOhmUtils.Convertor.string2object(Double.class, value);
        ...
        // long
        value = "100";
        converted = JOhmUtils.Convertor.string2object(Long.class, value);
        ...
        // bigdecimal
        value = "10.999";
        converted = JOhmUtils.Convertor.string2object(BigDecimal.class, value);
        assertTrue(converted.getClass().equals(BigDecimal.class));
        assertEquals(BigDecimal.valueOf(10.999d), converted);

        // biginteger
        value = "10999";
        converted = JOhmUtils.Convertor.string2object(BigInteger.class, value);
        ...
        converted = JOhmUtils.Convertor.string2object(Date.class, value);
    ...
    public void testSupportedConvertorsSignedValues() {
        // byte
        String value = "-50";
        Object converted = JOhmUtils.Convertor.string2object(Byte.class, value);
        assertTrue(converted.getClass().equals(Byte.class));
        assertEquals(Byte.valueOf("-50"), converted);
        ...
        // object
        value = "User";
        converted = JOhmUtils.Convertor.string2object(User.class, value);
    ...
    public void testUnsupportedConvertors() {
        String value = "10";
        Object converted = JOhmUtils.Convertor.string2object(new int[] {}.getClass(),
                value);
        assertNull(converted);

        converted = JOhmUtils.Convertor.string2object(Enum.class, value);
        assertNull(converted);

        converted = JOhmUtils.Convertor.string2object(Collection.class, value);
        assertNull(converted);
    }
}
